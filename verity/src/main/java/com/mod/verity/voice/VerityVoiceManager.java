...
public class VerityVoiceManager {
    ...
    public static void playVoiceSound(ServerLevel world, BlockPos pos, String soundName, float volume, float pitch) {
        try {
            SoundEvent soundEvent = Registries.SOUND_EVENT.get(ResourceLocation.fromNamespaceAndPath("verity", soundName));
            if (soundEvent != null) {
    ...
    public static boolean isVoiceAvailable() {
        ...
        return Registries.SOUND_EVENT.get(ResourceLocation.fromNamespaceAndPath("verity", "hello")) != null;
    }
}